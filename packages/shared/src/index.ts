...
export type SetupState="FORMING"|"TRIGGERED"|"INVALIDATED"|"NO_TRADE";
...
export interface Signal{symbol:string;exchange:ExchangeName;market:MarketType;direction:Direction;setupState:SetupState;confidence:number;entry:number;stopLoss:number;targets:number[];riskReward:number;reasons:string[];confirmations:string[];invalidation:string;createdAt:number}
